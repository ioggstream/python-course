...
Replication is $asynchronous$ and the agreements are configured on the slave only.
    ...
    \end{itemize}
\column[t]{.5\textwidth}
\includegraphics[height=3cm]{mysql-replica-hla.jpg}
...
\end{pycode*}
\end{itemize}
\includegraphics[height=4cm]{mysql-propagate-gtid.jpg}
...
In case of fault you should:
 ...
 \end{itemize}
\includegraphics[height=4cm]{mysql-promote-slave.jpg}
...
\includegraphics[height=6.6cm,width=12cm]{mysql-fabric-hla.jpg}
