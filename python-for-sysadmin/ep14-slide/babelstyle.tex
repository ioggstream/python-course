...
\usepackage{url, srcltx, hyperref}
%\usepackage{srcltx}
%\usepackage{hyperref}
...
\newenvironment{pyframe}[2][]
  {\begin{frame}[fragile,environment=pyframe,#1]
  \frametitle{#2}}
  {\end{frame}}
...
\setbeamertemplate{footline}{
    \hskip5pt \insertsection : \insertsubsection
    \centerline{
        \gray{\insertshortauthor}
    }
}
