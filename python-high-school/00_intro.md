...
a = 1  # is an integer
e = 1e2 # another integer in exponential notation
b = 0x10  # is another integer in hexadecimal (hex) notation
```
...
```python
# Exercise: use the print() function to print the value of a, e and b.

```

----

Python supports the octal notation too!
...
#### Bonus topic: Printing Characters
...
$chr : \mathbb{Z}_{255} \rightarrow ASCII$
$ord : TABLE \rightarrow \mathbb{Z}_{255}$
